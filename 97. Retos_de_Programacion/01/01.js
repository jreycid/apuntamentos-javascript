/*
 * EXERCICIO:
 * - Crea exemplos usando todos os operadores JavaScript
 * - Crea exemplos usando todos as estruturas de control de JavaScript
 * - Debes imprimir o resultado de todos os exemplos a través da consola.
 *
 * DIFICULTADE EXTRA (opcional):
 * Crear un programa que imprima por consola todos os números comprendidos
 * entre 10 e 55 (incluidos), pares, e que non sexan nin o 16 nin múltiplos de 3.
 */
